        ...
        case "production":
            ...
            if(process.env.AWS_REGION == undefined || process.env.SERVICE_URL == undefined || process.env.SNS_ROLE_ARN == undefined || process.env.AWS_ACCOUNT_ID == undefined )
            {
                ...
                config = {
                    ...
                    url: {
                        tenant: protocol + process.env.SERVICE_URL + '/tenant',
                        user: protocol + process.env.SERVICE_URL + '/user',
                        product: protocol + process.env.SERVICE_URL + '/product',
                        reg: protocol + process.env.SERVICE_URL + '/reg',
                        auth: protocol + process.env.SERVICE_URL + '/auth',
                        order: protocol + process.env.SERVICE_URL + '/order',
                        sys: protocol + process.env.SERVICE_URL + '/sys'
                    }
                }
                return config;
                break;
